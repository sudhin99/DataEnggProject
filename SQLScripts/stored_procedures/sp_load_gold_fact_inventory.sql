...
DROP PROCEDURE IF EXISTS sp_load_gold_fact_inventory$$

CREATE PROCEDURE sp_load_gold_fact_inventory()
BEGIN
    DECLARE v_started_at TIMESTAMP;
    DECLARE v_rows_merged INT DEFAULT 0;
    DECLARE v_sp_name VARCHAR(100) DEFAULT 'sp_load_gold_fact_inventory';
    DECLARE v_layer VARCHAR(20) DEFAULT 'GOLD';
    DECLARE v_target_table VARCHAR(100) DEFAULT 'GOLD.FACT_INVENTORY';
