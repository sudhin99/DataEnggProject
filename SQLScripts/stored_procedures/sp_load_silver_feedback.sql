...
DROP PROCEDURE IF EXISTS sp_load_silver_feedback$$

CREATE PROCEDURE sp_load_silver_feedback()
BEGIN
    ...
    DECLARE v_sp_name VARCHAR(100) DEFAULT 'sp_load_silver_feedback';
    ...
    IF v_new_watermark IS NULL THEN
        ...
        SELECT 'No new records to process in STG_FEEDBACK' AS result;
        LEAVE proc_label;
    END IF;
