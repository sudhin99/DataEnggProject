...
DROP PROCEDURE IF EXISTS sp_load_gold_fact_feedback_reviews$$

CREATE PROCEDURE sp_load_gold_fact_feedback_reviews()
BEGIN
    DECLARE v_started_at TIMESTAMP;
    DECLARE v_rows_feedback INT DEFAULT 0;
    DECLARE v_rows_reviews INT DEFAULT 0;
    DECLARE v_sp_name VARCHAR(100) DEFAULT 'sp_load_gold_fact_feedback_reviews';
    DECLARE v_layer VARCHAR(20) DEFAULT 'GOLD';
    DECLARE v_target_table VARCHAR(100) DEFAULT 'GOLD.FACT_FEEDBACK_REVIEWS';
